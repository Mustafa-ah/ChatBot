    ...
    public class CustomSlider : AbsoluteLayout
    {
       ...
       BindableProperty.Create(
        ...
        public static readonly BindableProperty FillBarProperty =
            BindableProperty.Create(
                "FillBar", typeof(View), typeof(CustomSlider),
                defaultValue: default(View));
        ...
        async void OnPanGestureUpdated(object sender, PanUpdatedEventArgs e)
        {
            ...
            switch (e.StatusType)
            {
                ...
                case GestureStatus.Completed:
                    ...
                    //    TrackBar.FadeTo(1, _animLength),Thumb.TranslateTo(0, 0, _animLength * 2, Easing.CubicIn)});
                    //}
        ...
        void OnSizeChanged(object sender, EventArgs e)
        {
            ...
            SetLayoutFlags(_gestureListener, AbsoluteLayoutFlags.All);
